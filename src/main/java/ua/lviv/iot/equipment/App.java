...
public class App {
    public static void main(final String[] args) {
        ...
        equipment.add(new Scenery(2, 56, 28, FilmType.HISTORICAL));
        equipment.add(new Scenery(3, 12, 3, FilmType.DOCUMENTARY));
        equipment.add(new Scenery(6, 221, 64, FilmType.HISTORICAL));
